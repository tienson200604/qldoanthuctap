...
public class UserApi {
    ...
    public ResponseEntity<?> changeRole(@RequestParam Long id, @RequestParam String role) throws URISyntaxException {
    ...
    public ResponseEntity<?> importUser(@RequestParam("file") MultipartFile file){
        ...
        Map<String, Object> result = userService.importUser(file);
